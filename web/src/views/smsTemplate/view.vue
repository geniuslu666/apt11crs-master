  ...
  <div>
    <n-drawer v-model:show="showModal" :width="dialogWidth">
      <n-drawer-content closable :header-style="{
        ...
        <template #header>
          <div style="font-weight: 500;font-size: 18px;color: #3D3D3D;line-height: 25px;">帮助中心分类详情</div>
        </template>
            ...
            <n-grid y-gap="25" :cols="2">
              <n-gi span="2">
                <div class="level-detail-div-item">
                  <div class="level-detail-div-item-title">分类名称</div>
...
import { View } from '@/api/pmsHelpcenterCategory';
