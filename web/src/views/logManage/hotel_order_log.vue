...
import {hotelOrderLogList} from '@/api/orderLog';
import { columns, schemas, options, loadOptions } from './hotel_order_model';
...
const loadDataTable = async (res) => {
  return await hotelOrderLogList({ ...searchFormRef.value?.formModel, ...res });
};
