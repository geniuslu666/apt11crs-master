...
import {foodOrderLogList} from '@/api/orderLog';
import { columns, schemas, options, loadOptions } from './food_order_model';
...
const loadDataTable = async (res) => {
  return await foodOrderLogList({ ...searchFormRef.value?.formModel, ...res });
};
