...
import {spaOrderLogList} from '@/api/orderLog';
import { columns, schemas, options, loadOptions } from './spa_order_model';
...
const loadDataTable = async (res) => {
  return await spaOrderLogList({ ...searchFormRef.value?.formModel, ...res });
};
