  ...
  <div>
    <n-drawer v-model:show="showModal" :width="dialogWidth">
      <n-drawer-content closable :header-style="{
        ...
        <template #header>
          <div style="font-weight: 500;font-size: 18px;color: #3D3D3D;line-height: 25px;">渠道管理详情</div>
        </template>
            ...
            <n-grid y-gap="25" :cols="3">
              <n-gi>
                <div class="level-detail-div-item">
                  <div class="level-detail-div-item-title">渠道名</div>
...
const getInfo = async () => {
  loading.value = true;
  const res =  await View({id: channelId.value})
  data.value = res;
  loading.value = false;
};
