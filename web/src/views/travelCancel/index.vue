        ...
        >
          <n-grid cols="1 s:1 m:1 l:1 xl:1 2xl:1" responsive="screen">
            <n-gi span="1">
              ...
              <n-form-item label=" " path="afterConfirmCancel" v-if="formValue.allowCancel == 1" >
                <n-input-group>
                  <n-input-group-label>距离订单服务开始</n-input-group-label>
                  <n-input-number placeholder="请输入" :min="0" v-model:value="formValue.freeCancelDays" style="width: 100px" />
                  <n-input-group-label>天前可免费取消，之后取消费为订单金额的</n-input-group-label>
...
<script lang="ts" setup>
  ...
  const rules = ref({});
  const group = ref('travelCancelPolicy');
