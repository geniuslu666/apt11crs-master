        ...
        <n-spin :show="loading" description="请稍候...">
          ...
          >
            <n-grid cols="2 s:1 m:1 l:2 xl:2 2xl:1" responsive="screen">
              ...
              <n-gi span="2">
                <n-form-item label="餐厅名称" path="restaurantName">
...
import {Verify} from "@/api/foodSettlementOrder";
...
function openModal(record) {
  ...
  formValue.value.restaurantId = record.restaurantId;
  formValue.value.restaurantName = record.restaurantDetail.name;
