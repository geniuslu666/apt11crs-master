  ...
  <div>
    <div class="n-layout-page-header">
      <n-spin :show="show" description="请稍候...">
        <n-card :bordered="false" :title="restaurantName+ ' - 店铺结算'">
...
import { SettleOrderList } from '@/api/foodOrder';
import { columns, schemas } from './order';
import { adaTableScrollX, getOptionLabel } from '@/utils/hotgo';
import {useRouter} from "vue-router";
import {View as SettlementOrderView} from "@/api/foodSettlementOrder";
...
async function loadSettlementView(){
  ...
  restaurantName.value = info.restaurantDetail.name
