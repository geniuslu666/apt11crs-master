        ...
        <n-grid cols="1">
          ...
          <n-gi>
            <div style="margin-left: 40px">
              <n-form-item label="滚动间隔" path="interval">
                <n-input-group>
                  <n-input v-model:value="formValue.scrollInterval" :style="{ width: '150px' }" />
...
import { columns, loadOptions } from './index_banner_model';
import { List, Delete } from '@/api/pmsIndexBanner';
import {PlusOutlined} from "@vicons/antd";
import Edit from "@/views/appsystem/indexBannerEdit.vue";

const actionRef = ref();
const dialog = useDialog();
const formBtnLoading = ref(false);
const group = ref('indexbanner');
