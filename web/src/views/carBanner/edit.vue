          ...
          >
            <n-grid cols="1 s:1 m:1 l:1 xl:1 2xl:1" responsive="screen">
              ...
              <n-gi span="1">
                ...
                <div style="color:#9EA4AA; font-size: 12px;line-height: 34px;margin: 0 0 24px;padding-left: 100px;">建议尺寸：750px*570px</div>
              </n-gi>
              <n-gi span="1">
...
import { Edit, View, MaxSort } from '@/api/carBanner';
