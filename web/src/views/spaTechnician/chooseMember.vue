...
const emit = defineEmits(['reloadMember']);
...
const actionColumn = reactive({
  ...
  render(record) {
    return h(TableAction as any, {
      ...
      actions: [
        {
          label: chooseMemberId.value == record.id ? '已绑定' : '绑定',
