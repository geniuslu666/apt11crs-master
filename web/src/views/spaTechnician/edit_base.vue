    ...
    <n-spin :show="show" description="请稍候...">
      ...
      >
        <n-grid cols="1 s:1 m:1 l:1 xl:1 2xl:1" responsive="screen">
          ...
          <n-gi span="1">
            <n-form-item label="照片" path="photo" :show-require-mark="false" :show-feedback='false'>
...
import {loadOptions, options} from "@/views/spaTechnician/model";
...
async function initData(data){
  formValue.value = {
    type: 'basic',
    id: data.id,
    ispId: data.ispId ? data.ispId : null,
