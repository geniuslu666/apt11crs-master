  ...
  <div>
    <n-drawer v-model:show="showModal" :width="dialogWidth">
      <n-drawer-content closable :header-style="{
        ...
        <template #header>
          <div style="font-weight: 500;font-size: 18px;color: #3D3D3D;line-height: 25px;">{{ formValue.id > 0 ? '编辑礼品券分类 #' + formValue.id : '添加礼品券分类' }}</div>
        </template>
        <template #footer>
              ...
              <n-grid :cols="1">
                <n-gi span="1">
                  <n-form-item label="分类名称" path="name">
                    <n-input placeholder="请输入分类名称" v-model:value="formValue.name" style="width: 300px"/>
                  </n-form-item>
                </n-gi>
                <n-gi span="1">
...
import { Edit, View } from '@/api/thCouponCategory';
