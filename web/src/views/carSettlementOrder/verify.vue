        ...
        <n-spin :show="loading" description="请稍候...">
          ...
          >
            <n-grid cols="2 s:1 m:1 l:2 xl:2 2xl:1" responsive="screen">
              ...
              <n-gi span="2">
                <n-form-item label="司机名称" path="driverName">
...
import {Verify} from "@/api/carSettlementOrder";
...
function openModal(record) {
  ...
  formValue.value.driverId = record.driverId;
  formValue.value.driverName = record.driverDetail.name;
