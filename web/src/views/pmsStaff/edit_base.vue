        ...
        <n-spin :show="loading" description="请稍候...">
          ...
          >
            <n-grid :cols="1">
              ...
              <n-gi v-if="formValue.type == 'department'">
                <n-form-item label="员工部门" path="department">
                  <n-input placeholder="请输入员工部门" v-model:value="formValue.department" :style="{ width: '300px' }"/>
                </n-form-item>
              </n-gi>
...
import {adaModalWidth} from "@/utils/hotgo";
  ...
  function openModal(id, baseType, value) {
    ...
    formValue.value.department = value.department
    ...
    if(baseType == 'name'){
      baseTitle.value = '编辑员工姓名'
    }else if(baseType == 'department'){
      baseTitle.value = '编辑员工部门'
