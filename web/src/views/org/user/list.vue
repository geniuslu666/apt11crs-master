  ...
  <div>
    ...
    >
      ...
      >
        ...
        <n-grid x-gap="24" :cols="2">
          <n-gi>
            <n-form-item label="接待模式" path="reception">
              <n-select
                placeholder="请选择接待模式"
                v-model:value="formParams.reception"
        ...
        <n-grid x-gap="24" :cols="1">
          <n-gi>
            <n-form-item label="绑定物业" path="receptionValue">
              <n-select
                placeholder="请选择客服绑定的物业"
                v-model:value="formParams.receptionValueArr"
        ...
        <!--        <n-form-item label="客服账号" path="kefuAccount">
          <n-input  placeholder="请输入客服账号" v-model:value="formParams.kefuAccount" />
        </n-form-item>-->
...
<script lang="ts" setup>
  ...
  function confirmForm(e) {
    ...
    formRef.value.validate((errors) => {
      if (!errors) {
        if (formParams.value.receptionValueArr && formParams.value.receptionValueArr.length > 0) {
          formParams.value.receptionValue = formParams.value.receptionValueArr.join(',');
        }
  ...
  function handleEdit(record: Recordable) {
    ...
    var receptionValue = record.receptionValue != '' ? record.receptionValue.split(',') : [];
    record.receptionValueArr = receptionValue.map(function (item) {
      return parseInt(item, 10); // 第二个参数10表示十进制
    });
