        ...
        >
          <n-grid cols="1 s:1 m:1 l:1 xl:1 2xl:1" responsive="screen">
            <n-gi span="1">
              ...
              <n-form-item label="订单确认前" path="beforeConfirmCancelRate" v-if="formValue.cancelPolicyOpen == 1" style="margin-bottom: 24px">
                <n-input-group>
                  <n-input-group-label>未确认前任何时候都可以免费取消</n-input-group-label>
                </n-input-group>
              </n-form-item>
              <n-form-item label="订单确认后" path="afterConfirmCancel" v-if="formValue.cancelPolicyOpen == 1" >
                <n-input-group>
                  ...
                  <n-input-group-label>小时前取消，取消费为订单金额的</n-input-group-label>
...
<script lang="ts" setup>
  ...
  const rules = ref({});
  const group = ref('spacancelpolicy');
