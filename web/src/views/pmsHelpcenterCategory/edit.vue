  ...
  <div>
    <n-drawer v-model:show="showModal" :width="dialogWidth" :z-index="99">
      <n-drawer-content closable :header-style="{
        ...
        <template #header>
          <div style="font-weight: 500;font-size: 18px;color: #3D3D3D;line-height: 25px;">{{ formValue.id > 0 ? '编辑帮助中心分类 #' + formValue.id : '添加帮助中心分类' }}</div>
        </template>
        <template #footer>
...
import { Edit, View } from '@/api/pmsHelpcenterCategory';
