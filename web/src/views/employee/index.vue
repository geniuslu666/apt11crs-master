  ...
  <div>
    <div class="n-layout-page-header" style="margin: 0">
      <n-card :bordered="false" :header-style="{
        ...
        <template #header>
          <text style="font-weight: 500;font-size: 18px;color: #3D3D3D;line-height: 25px;">员工管理</text>
        </template>
...
import { List, Delete, Status, Unbind } from '@/api/employee';
...
import Bind from '@/views/employee/bind.vue';
import {useRouter} from "vue-router";
import View from "@/views/employee/view.vue";
