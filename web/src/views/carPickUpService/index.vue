  ...
  <div>
    <div class="n-layout-page-header">
      <n-card :bordered="false" :header-style="{
        ...
        <template #header>
          <text style="font-weight: 500;font-size: 18px;color: #3D3D3D;line-height: 25px;">接机服务</text>
        </template>
...
// 添加数据
function addTable() {
  router.push({ name: 'carPickUpServiceEdit', params: { id: null } });
}

// 编辑数据
function handleEdit(record: Recordable) {
  router.push({ name: 'carPickUpServiceEdit', params: { id: record.id } });
}
