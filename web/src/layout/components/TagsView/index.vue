<template>
  ...
  >
    <div class="tabs-view-main">
      ...
      <div class="tabs-close" style="display: flex;align-items: center;cursor: default;width: auto">
        <div style="display: flex;align-items: center;">
          <div style="display: flex;align-items: center;margin-right: 20px;cursor: pointer" @click="reloadPage">
            <img src="~@/assets/images/new/reload_icon.png" alt="" style="width: 16px;height: 16px"/>
<!--            <text style="margin-left: 5px;font-weight: 400;font-size: 14px;color: #3D3D3D;line-height: 20px;">刷新页面</text>-->
          </div>
          <n-dropdown
            trigger="hover"
          ...
          >
            <div style="display: flex;align-items: center;cursor: pointer">
              <img src="~@/assets/images/new/more_icon.png" alt="" style="width: 16px;height: 16px"/>
<!--              <text style="margin-left: 5px;font-weight: 400;font-size: 14px;color: #3D3D3D;line-height: 20px;">更多</text>-->
            </div>
          </n-dropdown>
        </div>
<!--        <n-dropdown-->
