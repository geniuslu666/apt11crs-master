...
// SendCode 发送验证码
func (d *AliYunDrive) SendCode(ctx context.Context, in *input_basics.SendCodeInp) (err error) {
...
// SendMsg 发送消息
func (d *AliYunDrive) SendMsg(ctx context.Context, in *input_basics.SendMsgInp) (err error) {
	...
	sendSmsRequest := &dysmsapi20170525.SendSmsRequest{
		...
		SignName:      tea.String(config.AliYunSign),
		TemplateCode:  tea.String(in.Template),
		TemplateParam: tea.String(gjson.New(in.TemplateParams).String()),
	}
