...
// SetMemberUser 将上下文信息设置到上下文请求中，注意是完整覆盖
func SetMemberUser(ctx context.Context, user *model.MemberIdentity) {
	c := Get(ctx)
	if c == nil {
		g.Log().Warning(ctx, "contexts.SetMemberUser, c == nil ")
		return
	}
	c.MemberUser = user
}

// SetTerminalUser 将上下文信息设置到上下文请求中，注意是完整覆盖
func SetTerminalUser(ctx context.Context, user *model.TerminalIdentity) {
	c := Get(ctx)
	if c == nil {
		g.Log().Warning(ctx, "contexts.SetTerminalUser, c == nil ")
		return
	}
	c.TerminalUser = user
}

// SetTravelStaffUser 将上下文信息设置到上下文请求中，注意是完整覆盖
func SetTravelStaffUser(ctx context.Context, user *model.TravelStaffIdentity) {
	c := Get(ctx)
	if c == nil {
		g.Log().Warning(ctx, "contexts.SetTravelStaffUser, c == nil ")
		return
	}
	c.TravelStaffUser = user
}
...
// GetMemberUser 获取用户信息
func GetMemberUser(ctx context.Context) *model.MemberIdentity {
	c := Get(ctx)
	if c == nil {
		return nil
	}
...
// GetTerminalUser 获取用户信息
func GetTerminalUser(ctx context.Context) *model.TerminalIdentity {
	c := Get(ctx)
	if c == nil {
		return nil
	}
	return c.TerminalUser
}

// GetTravelStaffUser 获取一日游核销员信息
func GetTravelStaffUser(ctx context.Context) *model.TravelStaffIdentity {
	c := Get(ctx)
	if c == nil {
		return nil
	}
	return c.TravelStaffUser
}
...
func SetLanguage(ctx context.Context, language string) {
	c := Get(ctx)
	if c == nil {
		g.Log().Warning(ctx, "contexts.SetLanguage, c == nil ")
		return
	}
	Get(ctx).Data["language"] = language
}
...
func GetLanguage(ctx context.Context) string {
	...
	if lang, ok := c.Data["language"].(string); ok {
		return lang
	}
	return ""
}
...
func GetGatewayCode(ctx context.Context) *model_gateway.GatewayCode {
	c := Get(ctx)
	if c == nil {
		return nil
	}
	return c.GatewayCode
}

func SetGatewayCode(ctx context.Context, vs *model_gateway.GatewayCode) {
	c := Get(ctx)
	if c == nil {
		g.Log().Warning(ctx, "contexts.SetModule, c == nil ")
		return
