...
func (d *LocalDrive) UploadFile(ctx context.Context, filePath string) (fullPath string, err error) {
	fullPath = filePath
	return
}
...
func (d *LocalDrive) UploadFileName(ctx context.Context, filePath string, fileName string) (fullPath string, err error) {
	fullPath = filePath
	return
}
