...
func (l *gCurd) generateStructFieldDefinition(in *CurdPreviewInput, field *input_basics.GenCodesColumnListModel, inputType int, isMaster bool) []string {
	var (
		tagKey         = "`"
...
func makeValidatorFunc(field *input_basics.GenCodesColumnListModel) (err error, rule string) {
