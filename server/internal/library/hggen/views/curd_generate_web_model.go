...
func (l *gCurd) generateWebModelFormSchemaEach(buffer *bytes.Buffer, fields []*input_basics.GenCodesColumnListModel, in *CurdPreviewInput) {
...
func (l *gCurd) generateWebModelColumnsEach(buffer *bytes.Buffer, in *CurdPreviewInput, fields []*input_basics.GenCodesColumnListModel) (err error) {
	for _, field := range fields {
		if !field.IsList {
			continue
		}
