...
// LineWrapColumn Column to wrap lines to (disabled by default)
var LineWrapColumn = 0

// LineWrapMaxSpillover Maxmimum characters a long word can extend past LineWrapColumn without wrapping
