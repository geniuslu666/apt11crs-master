...
func HasColumn(fields []*input_basics.GenCodesColumnListModel, column string) bool {
...
func HasColumnWithFormMode(fields []*input_basics.GenCodesColumnListModel, formMode string) bool {
	for _, field := range fields {
...
func HasMaxSort(fields []*input_basics.GenCodesColumnListModel) bool {
	return HasColumn(fields, "Sort")
}

func HasStatus(headOps []string, fields []*input_basics.GenCodesColumnListModel) bool {
...
func HasSwitch(fields []*input_basics.GenCodesColumnListModel) bool {
	return HasColumnWithFormMode(fields, FormModeSwitch)
}

func HasHookMemberSummary(fields []*input_basics.GenCodesColumnListModel) bool {
	for _, field := range fields {
...
func HasQueryMemberSummary(fields []*input_basics.GenCodesColumnListModel) bool {
	for _, field := range fields {
		if IsMemberSummaryField(field.Name) {
			if field.IsQuery {
				return true
...
func ReviseFields(fields []*input_basics.GenCodesColumnListModel) []*input_basics.GenCodesColumnListModel {
	for _, field := range fields {
