...
func DoTableColumns(ctx context.Context, in *input_basics.GenCodesColumnListInp, config gendao.CGenDaoInput) (fields []*input_basics.GenCodesColumnListModel, err error) {
	var (
...
func CustomLinkAttributes(ctx context.Context, alias string, field *input_basics.GenCodesColumnListModel, in gendao.CGenDaoInput) {
...
func CustomAttributes(ctx context.Context, field *input_basics.GenCodesColumnListModel, in gendao.CGenDaoInput) {
	field.GoName, field.GoType, field.TsName, field.TsType = GenGotype(ctx, field, in)
	setDefault(field)
}

// GenGotype 生成字段的go类型
func GenGotype(ctx context.Context, field *input_basics.GenCodesColumnListModel, in gendao.CGenDaoInput) (goName, typeName, tsName string, tsType string) {
	var err error
