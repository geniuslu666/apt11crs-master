...
// setDefault 设置默认属性
func setDefault(field *input_basics.GenCodesColumnListModel) {
...
func setDefaultEdit(field *input_basics.GenCodesColumnListModel) {
	field.IsEdit = true
...
func setDefaultFormMode(field *input_basics.GenCodesColumnListModel) {
...
func setDefaultFormRole(field *input_basics.GenCodesColumnListModel) {
...
func setDefaultDictType(field *input_basics.GenCodesColumnListModel) {
	if gstr.HasSuffix(field.GoName, "Status") && IsNumberType(field.GoType) {
...
func setDefaultList(field *input_basics.GenCodesColumnListModel) {
	field.IsList = true
	switch field.GoType {
...
func setDefaultExport(field *input_basics.GenCodesColumnListModel) {
	field.IsExport = true
	switch field.GoType {
	case GoTypeIntSlice, GoTypeInt64Slice, GoTypeUint64Slice, GoTypeBytes, GoTypeJson:
...
func setDefaultQuery(field *input_basics.GenCodesColumnListModel) {
	field.IsQuery = false
...
func setDefaultQueryWhere(field *input_basics.GenCodesColumnListModel) {
...
func setDefaultValue(field *input_basics.GenCodesColumnListModel) {
	var value interface{}
