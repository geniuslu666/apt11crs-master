...
type sBasicsAdminPost struct{}

func NewBasicsAdminPost() *sBasicsAdminPost {
	return &sBasicsAdminPost{}
}

func init() {
	service.RegisterBasicsAdminPost(NewBasicsAdminPost())
	dict.RegisterFunc("adminPostOption", "岗位选项", service.BasicsAdminPost().Option)
}

// Delete 删除
func (s *sBasicsAdminPost) Delete(ctx context.Context, in *input_basics.PostDeleteInp) (err error) {
...
func (s *sBasicsAdminPost) VerifyUnique(ctx context.Context, in *input_basics.VerifyUniqueInp) (err error) {
	if in.Where == nil {
		return
	}
...
// Edit 修改/新增
func (s *sBasicsAdminPost) Edit(ctx context.Context, in *input_basics.PostEditInp) (err error) {
	// 验证唯一性
...
// MaxSort 最大排序
func (s *sBasicsAdminPost) MaxSort(ctx context.Context, in *input_basics.PostMaxSortInp) (res *input_basics.PostMaxSortModel, err error) {
	if in.Id > 0 {
	...
	if res == nil {
		res = new(input_basics.PostMaxSortModel)
	}
...
// View 获取指定岗位信息
func (s *sBasicsAdminPost) View(ctx context.Context, in *input_basics.PostViewInp) (res *input_basics.PostViewModel, err error) {
	err = dao.AdminPost.Ctx(ctx).WherePri(in.Id).Scan(&res)
	return
}

// List 获取列表
func (s *sBasicsAdminPost) List(ctx context.Context, in *input_basics.PostListInp) (list []*input_basics.PostListModel, totalCount int, err error) {
...
// Option 岗位选项
func (s *sBasicsAdminPost) Option(ctx context.Context) (opts []*model.Option, err error) {
...
func (s *sBasicsAdminPost) GetMemberByStartName(ctx context.Context, memberId int64) (name string, err error) {
	// 默认取第一岗位
...
// Status 更新状态
func (s *sBasicsAdminPost) Status(ctx context.Context, in *input_basics.PostStatusInp) (err error) {
