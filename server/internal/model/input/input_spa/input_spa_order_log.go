...
// SpaOrderLogListInp 获取餐厅套餐预订单列表
type SpaOrderLogListInp struct {
	input_form.PageReq
...
func (in *SpaOrderLogListInp) Filter(ctx context.Context) (err error) {
	return
}

type SpaOrderLogListModel struct {
	entity.SpaOrderLog
