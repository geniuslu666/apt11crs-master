...
// SpaTechnician is the golang structure of table hg_spa_technician for DAO operations like Where/Data.
type SpaTechnician struct {
	g.Meta                `orm:"table:hg_spa_technician, do:true"`
	Id                    interface{} //
	IspId                 interface{} // 服务商ID
	IsLeader              interface{} // 是否是店长 1是  2否
	Name                  interface{} // 技师真实姓名
	Nickname              interface{} // 技师昵称
