...
// FoodSettlementOrder is the golang structure of table hg_food_settlement_order for DAO operations like Where/Data.
type FoodSettlementOrder struct {
	g.Meta           `orm:"table:hg_food_settlement_order, do:true"`
	Id               interface{} //
